...
namespace TrackerWPFUI.ViewModels
{
    public class CreatePersonViewModel : Screen
    {
        ...
        {
            await EventAggregationProvider.TrackerEventAggregor.PublishOnUIThreadAsync(new PersonModel());
        ...
        public async Task CreatePersonAsync(string firstName, string lastName, string email, string cellphone)
        {
            ...
            await EventAggregationProvider.TrackerEventAggregor.PublishOnUIThreadAsync(p);
            await this.TryCloseAsync();
        }
    }
}
