...
namespace TrackerWPFUI.ViewModels
{
    public class CreateTeamViewModel : Conductor<object>, IHandle<PersonModel>
    {
        ...
        {
            await ActivateItemAsync(new CreatePersonViewModel(), new CancellationToken());
        ...
        {
            await EventAggregationProvider.TrackerEventAggregor.PublishOnUIThreadAsync(new TeamModel());
        ...
        public async Task CreateTeam()
        {
            ...
            await EventAggregationProvider.TrackerEventAggregor.PublishOnUIThreadAsync(t);
            await this.TryCloseAsync();
        }
